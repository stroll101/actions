...
[ -f target/linux/rockchip-rk3328/config-5.4 ] && sed -i '/CONFIG_CGROUPS/a\CONFIG_CGROUP_PERF=y' target/linux/rockchip-rk3328/config-5.4
[ -f target/linux/allwinner-h5/config-5.4 ] &&    sed -i '/CONFIG_CGROUPS/a\CONFIG_CGROUP_PERF=y' target/linux/allwinner-h5/config-5.4
